...
function SettingsGearIcon({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M6.5 1.5H9.5L9.9 3.1C10.3 3.3 10.7 3.5 11.1 3.8L12.6 3.1L14.1 5.7L12.8 6.8C12.9 7.2 12.9 7.6 12.8 8L14.1 9.1L12.6 11.7L11.1 11C10.7 11.3 10.3 11.5 9.9 11.7L9.5 13.3H6.5L6.1 11.7C5.7 11.5 5.3 11.3 4.9 11L3.4 11.7L1.9 9.1L3.2 8C3.1 7.6 3.1 7.2 3.2 6.8L1.9 5.7L3.4 3.1L4.9 3.8C5.3 3.5 5.7 3.3 6.1 3.1L6.5 1.5Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <circle cx="8" cy="7.4" r="2.2" stroke="currentColor" strokeWidth="1.5" />
    </svg>
  );
}
...
const adminNavItems = [
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0 transition-transform duration-200 group-hover:-translate-y-0.5">
        <g clipPath="url(#clip0_18_140_admin)">
        ...
        <defs>
          <clipPath id="clip0_18_140_admin">
  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0 transition-transform duration-200 group-hover:-translate-y-0.5">
        <g clipPath="url(#clip0_18_148_admin)">
          ...
          <path d="M6.0026 9.33333C6.37079 9.33333 6.66927 9.03486 6.66927 8.66667C6.66927 8.29848 6.37079 8 6.0026 8C5.63441 8 5.33594 8.29848 5.33594 8.66667C5.33594 9.03486 5.63441 9.33333 6.0026 9.33333Z" fill="currentColor" />
          <path d="M10.0026 9.33333C10.3708 9.33333 10.6693 9.03486 10.6693 8.66667C10.6693 8.29848 10.3708 8 10.0026 8C9.63441 8 9.33594 8.29848 9.33594 8.66667C9.33594 9.03486 9.63441 9.33333 10.0026 9.33333Z" fill="currentColor" />
          <path d="M12.0042 7.35333C11.6842 5.45333 10.0309 4 8.03754 4C6.01754 4 3.84421 5.67333 4.01754 8.3C5.66421 7.62667 6.90421 6.16 7.25754 4.37333C8.13088 6.12667 9.92421 7.33333 12.0042 7.35333Z" fill="currentColor" />
        </g>
        <defs>
          <clipPath id="clip0_18_148_admin">
            <rect width="16" height="16" fill="white" />
          </clipPath>
        </defs>
      </svg>
  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0 transition-transform duration-200 group-hover:-translate-y-0.5">
        <g clipPath="url(#clip0_18_159_admin)">
        ...
        <defs>
          <clipPath id="clip0_18_159_admin">
            <rect width="16" height="16" fill="white" />
          </clipPath>
        </defs>
      </svg>
...
const LogoutIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0 transition-transform duration-200 group-hover:translate-x-0.5">
    <g clipPath="url(#clip0_18_177_admin)">
    ...
    <defs>
      <clipPath id="clip0_18_177_admin">
        <rect width="16" height="16" fill="white" />
      </clipPath>
    </defs>
  </svg>
      ...
      <div className="mx-auto flex h-full w-full max-w-[1920px] items-center justify-between px-[210px]">
        ...
        <nav className="hidden flex-1 items-center lg:flex justify-start ml-[60px] gap-[30px]">
          ...
          <Link
            ...
            className={`group flex h-[44px] items-center justify-center px-3 py-3 transition-all duration-200 border-b-2 active:scale-[0.98] ${
              isSettingsActive
                ? "border-[#2abaef] text-[#2abaef]"
                : "border-transparent text-gray-500 hover:text-[#2abaef] hover:border-[#2abaef]/30"
            }`}
          >
            <SettingsGearIcon className="transition-transform duration-200 group-hover:rotate-45" />
          </Link>
        </nav>

        {/* Правый блок: Интерактивный поиск на странице и Выход */}
        <div className="ml-auto hidden items-center md:flex gap-[40px]">
          <div className="relative w-[340px] h-[52px] group">
            <input
              type="text"
